        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="text-center">
              <p className="font-syne font-bold text-2xl md:text-3xl text-white">5+</p>
              <p className="text-white/30 text-xs mt-1">ans sur Shopify</p>
            </div>
            <div className="text-center border-l border-white/[0.06]">
              ...
              <p className="text-white/30 text-xs mt-1">Expert Kanal France</p>
            </div>
          </div>

          {/* Quote */}
          <div className="border-t border-white/[0.06] pt-8 mb-8">
            <p className="text-white/60 text-lg leading-relaxed text-center max-w-2xl mx-auto">
